...
public class TouchImageViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mBannerActivityList.addAll(GoodsDetailActivity.mBannerActivityList);
	...
	static class TouchImageAdapter extends PagerAdapter {
		...
		private static int[] images = { R.drawable.menu_viewpager_1, R.drawable.menu_viewpager_1,
				R.drawable.actionsheet_single_normal };

		@Override
		public int getCount() {
			return mBannerActivityList.size();
		}
		...
		public View instantiateItem(ViewGroup container, int position) {
			...
			ImageLoader.getInstance().displayImage(mBannerActivityList.get(position).getImgUrl(), img);
