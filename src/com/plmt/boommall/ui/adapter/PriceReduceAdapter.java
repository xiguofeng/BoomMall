...
public class PriceReduceAdapter extends BaseAdapter {
	...
	public PriceReduceAdapter(Context context, ArrayList<NotifyGoodsInfo> datas,ListItemClickHelp callback) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.list_price_reduce_item, null);

			holder = new ViewHolder();
			holder.mName = (TextView) convertView
					.findViewById(R.id.list_price_reduce_name_tv);
			holder.mPrice = (TextView) convertView
					.findViewById(R.id.list_price_reduce_price_tv);

			holder.mIcon = (ImageView) convertView.findViewById(R.id.list_price_reduce_goods_iv);
			holder.mDelIv= (ImageView) convertView.findViewById(R.id.list_price_reduce_del_iv);
