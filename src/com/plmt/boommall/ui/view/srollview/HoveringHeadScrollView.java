...
public class HoveringHeadScrollView extends FrameLayout {
    ...
    public HoveringHeadScrollView(Context context) {
        this(context, null);
    }

    public HoveringHeadScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public HoveringHeadScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public HoveringHeadScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init() {
        post(new Runnable() {
            ...
            public void run() {
                ...
                MyScrollView scrollView = new MyScrollView(getContext(), HoveringHeadScrollView.this);
            ...
            public void run() {
                ...
                if (scrollY >= mTopViewTop
                    ...
                    addView(mTopContent);
                        ...
                        && mTopContent.getParent() == HoveringHeadScrollView.this) {
    ...
    private static class MyScrollView extends ScrollView {
        ...
        private HoveringHeadScrollView mScrollView;

        public MyScrollView(Context context, HoveringHeadScrollView scrollView) {
            super(context);
