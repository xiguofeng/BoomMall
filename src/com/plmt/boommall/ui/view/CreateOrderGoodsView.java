...
public class CreateOrderGoodsView extends LinearLayout {
	...
	public CreateOrderGoodsView(Context context, Goods goods) {
		super(context);
	...
	private void initView(final Context context, Goods goods) {
		...
		LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.create_order_goods, null);
